...
REQUIRED_CLAIMS = [
    ...
    ("article", "not as a second forecast-validation exercise"),
    ("article", "not as additional rolling-origin evidence"),
    ("article", "five rolling-origin cutoff dates that span contrasting hydrological conditions"),
    ...
    ("article", "time-ordered analogue of cross-validation"),
    ("article", "each fold fixes a forecast origin"),
    ("article", "scores the resulting predictive distribution against future USGS observations"),
    ("article", "feasible folds are constrained by version-consistent forecast archives"),
    ("article", "heavily overlapping forecast windows would overrepresent the same hydrological episode"),
    ...
    ("article", "rather than the full forecast distribution at a single origin"),
    ("article", "full synthesized posterior predictive distribution"),
    ...
    ("corrections", "representative illustration of the selected model at one forecast origin"),
    ("corrections", "not counted as additional forecast-validation evidence"),
    ("corrections", "organized around forecast origins rather than a conventional random split"),
    ("corrections", "time-ordered analogue of cross-validation"),
    ("corrections", "post-cutoff USGS observations are used only for verification"),
    ("corrections", "heavily overlapping forecast windows overrepresent the same hydrological regime"),
