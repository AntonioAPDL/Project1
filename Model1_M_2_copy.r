...
load(file_path)
#new.uts.out = new.uts.out_50_M 
#new.sts.out =  new.sts.out_50_M  
#new.gamsig.out = new.gamsig.out_50_M 
#new.theta.out = new.theta.out_50_M 
model$m0 <- new.theta.out_50_M$sm[,1]
...
samp.theta_50_M = samp.theta 
samp.post.pred_50_M = samp.post.pred 
