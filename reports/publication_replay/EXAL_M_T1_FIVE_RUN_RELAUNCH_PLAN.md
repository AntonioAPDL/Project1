...
Reproduce and relaunch only the five publication-relevant `exAL-M-T1` runs tied to the current CRPS table, and make those reruns emit the outputs needed to refresh `Evironmetrics---REVISED-DOC-Corrected-2`.
...
3. `Evironmetrics---REVISED-DOC-Corrected-2/FIGURE_TABLE_PROVENANCE.md`
4. `Evironmetrics---REVISED-DOC-Corrected-2/wileyNJD-APA.tex`
...
| Manuscript object | Role in `Evironmetrics---REVISED-DOC-Corrected-2` | Locked provenance role | Required rerun outputs |
|---|---|---|---|
...
Refresh `Evironmetrics---REVISED-DOC-Corrected-2` from the newly verified rerun outputs, starting with:
- `fig:synth1`
...
- refreshed Section 5 assets for `Evironmetrics---REVISED-DOC-Corrected-2`,
