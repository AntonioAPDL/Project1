...
Completed tasks:
- patched `Evironmetrics---REVISED-DOC-2/scripts/render_current_model_output_support_figures.R` so the internal scale is read from the replay contract instead of hardcoding `log_log1p_cms`;
