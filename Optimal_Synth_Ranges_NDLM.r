...
if (use_covariates) {
  ...
  model$C0 <- bdiag(model$C0, 0.005 * kk * diag(ppx))
...
if(USE_PREV){
  ...
  load(file_path)
  new.theta.out = new.theta.out_50_NDLM_synth 
}
...
while ( (FLAG || iter < 5) & (iter < max_iter) ) {
...
# ##############################################################################################################
# lower_bounds <- c(0.998, 0.988, 0.998, 0.93, 0.998, 0.998, 0)   
# upper_bounds <- c(0.999999, 0.999999, 0.999999, 0.999999, 0.999999, 0.999999, 1) 

# initial_delta <- c( 0.99999,  # Trend
#                     0.98956,    # Seas year and semester
#                     0.99999,  # Seas 80 month
#                     0.99989,    # Discrep
#                     0.99903, # Mem for Trans
#                     0.99999,   # Cov
#                     0.88173)     #Trans
...
# initial_delta <- c( 0.99989,    # Discrep
#                     0.99903, # Mem for Trans
#                     0.99999,   # Cov
#                     0.88173)     #Trans
# opts <- list("algorithm" = "NLOPT_LN_BOBYQA",  # Using a derivative-free algorithm
...
# ##############################################################################################################
# ##############################################################################################################
# lower_bounds <- c(0.999, 0.998, 0.998, 0.001, 0.28)   
...
lower_bounds <- c(0.9999, 0.01)   
upper_bounds <- c(0.9999999, 0.99)    
initial_delta <- c(0.99995,0.96)
