...
samp.gamma_90 = samp.gamma 
samp.sigma_90 = samp.sigma
samp.uts_90 = samp.uts
samp.sts_90 = samp.sts 
samp.theta_90 = samp.theta 
samp.post.pred_90 = samp.post.pred 
new.uts.out_90 = new.uts.out
new.sts.out_90 = new.sts.out 
new.gamsig.out_90 = new.gamsig.out 
new.theta.out_90 = new.theta.out
seq.gamma_90 = seq.gamma
seq.sigma_90 = seq.sigma

vars_to_save <- c("samp.gamma_90", "samp.sigma_90", 
                  "samp.uts_90", "samp.sts_90", 
                  "samp.theta_90", "samp.post.pred_90", 
                  "new.uts.out_90", "new.sts.out_90", 
                  "new.gamsig.out_90", "new.theta.out_90",
                  "seq.gamma_90", "seq.sigma_90")


save_variables(vars_to_save, "variables_90.RData", "/home/jaguir26/projects/notebooks")
