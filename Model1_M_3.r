...
samp.gamma_95_M = samp.gamma 
samp.sigma_95_M = samp.sigma
samp.uts_95_M = samp.uts
samp.sts_95_M = samp.sts 
samp.theta_95_M = result$samp_theta 
samp.post.pred_95_M = result$samp_post_pred 
new.uts.out_95_M = new.uts.out
new.sts.out_95_M = new.sts.out 
new.gamsig.out_95_M = new.gamsig.out  
new.theta.out_95_M = new.theta.out 
seq.gamma_95_M = seq.gamma 
seq.sigma_95_M = seq.sigma 
seq.elbo_95_M =  seq.elbo 


vars_to_save <- c("samp.gamma_95_M", "samp.sigma_95_M", 
                  "samp.uts_95_M", "samp.sts_95_M",
                  "samp.theta_95_M", "samp.post.pred_95_M", 
                  "new.uts.out_95_M", "new.sts.out_95_M", 
                  "new.gamsig.out_95_M", "new.theta.out_95_M",
                  "seq.gamma_95_M", "seq.sigma_95_M", "seq.elbo_95_M")
save_variables(vars_to_save, "variables_95_M.RData", "/home/jaguir26/projects/notebooks")
