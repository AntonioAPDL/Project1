...
- raw-ensemble companion PNGs are emitted beside the canonical figure for both posterior and NDLM predictive families
...
- `post/inputs/nws_post_adapter.csv` and `post/inputs/glofas_post_adapter.csv` for the raw-ensemble companion
...
- new companion rows such as `*_with_raw_ensembles`
