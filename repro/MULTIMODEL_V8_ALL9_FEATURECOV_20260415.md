...
- precipitation zero-stay gate:
  - when retrospective precipitation is `0`, set the final precipitation input to `0` with probability `0.9`
  - otherwise keep the blended value
