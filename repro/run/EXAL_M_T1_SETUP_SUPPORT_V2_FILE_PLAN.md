...
### 4. `Evironmetrics---REVISED-DOC-2/FIGURE_TABLE_PROVENANCE.md`
...
### 5. `Evironmetrics---REVISED-DOC-2/EXAL_M_T1_ARTIFACT_RUN_MAP.md`
...
### 6. `Evironmetrics---REVISED-DOC-2/MANUSCRIPT_REVISION_CHECKLIST.md`

Modify to:
- track the `v2` rollout explicitly
- prevent the old `v1` cutoff figure family from being treated as done

### 7. `Evironmetrics---REVISED-DOC-2/scripts/refresh_all_generated_assets.py`
