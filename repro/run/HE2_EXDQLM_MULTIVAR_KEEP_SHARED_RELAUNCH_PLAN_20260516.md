...
Prepare a clean, reproducible, no-launch relaunch package for `exdqlm_multivar_keep` using:

- the corrected shared-input bundle lineage,
- one shared exAL-M-T1 forecast-covariance prior,
- one shared discount-factor block,
- and the proven q50 stabilization layer from the successful 2026-05-15 recovery.
...
- report builder:
  - `scripts/build_he2_exdqlm_multivar_keep_shared_relaunch_plan.py`
- template:
...
```bash
python3 scripts/build_he2_exdqlm_multivar_keep_shared_relaunch_plan.py
```
