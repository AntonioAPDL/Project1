...
- Current renderer builds `component = 6` directly from state quantile arrays in:
  - `/data/muscat_data/jaguir26/project1_ucsc_phd/Evironmetrics---REVISED-DOC-2/scripts/render_current_model_output_support_figures.R`
...
Targets:
- `/data/muscat_data/jaguir26/project1_ucsc_phd/Evironmetrics---REVISED-DOC-2/wileyNJD-APA.tex`
- appendix-generation scripts under `Evironmetrics---REVISED-DOC-2/scripts`
...
- [x] `python3 Evironmetrics---REVISED-DOC-2/scripts/refresh_current_model_output_support_figures.py`
- [x] `python3 Evironmetrics---REVISED-DOC-2/scripts/refresh_exal_m_t1_generated_assets.py`
- [x] `python3 Evironmetrics---REVISED-DOC-2/scripts/refresh_all_generated_assets.py`
