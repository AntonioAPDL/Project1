...
Last updated: 2026-04-06 (tranche-1 active; auxiliary GLOFAS operational + forecast_download smoke validation complete)  
...
| `GLOFAS-OPS-AUX` | GLOFAS operational forecasts | ECMWF/CEMS operational medium-range | `operational`, interpreted by issue date | prior cache window `2019-11-05` to `2023-01-31` | `pass` | `family=glofas_operational_forecasts/outputs/download_root/` plus `outputs/forecast_cache/glofas/` | smoke-validated; defer broader auxiliary rebuild until after main five-family recovery |
...
| `GLOFAS-OPS-AUX-FULL` | smoke is validated, but broader auxiliary forecast rebuild is intentionally deferred until after the primary five-family recovery | deferred |
