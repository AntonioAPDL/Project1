...
DDD1 <- X[,1]-min(X[,1]); x1 <- DDD1; x1 <- x1/sd(x1);
DDD2 <- X[,2]-min(X[,2]); x2 <- DDD2; x2 <- x2/sd(x2);
DDD3 <- X[,3]-min(X[,3]); x3 <- DDD3; x3 <- x3/sd(x3);
# X <- cbind(x1,x2,x3)
DDD4 <- rep(1,TT); x4 <- DDD4; x4 <- x4;
X <- cbind(x1,x2,x3,x4)
# x5 <- c(0,x1[1:(TT-1)]); 
...
initial_delta   <- c(0.9999995, 0.9981, 0.9981, 0.9995 , 0.999   , 0.985)
