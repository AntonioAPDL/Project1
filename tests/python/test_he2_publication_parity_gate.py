...
class He2PublicationParityGateTests(unittest.TestCase):
    def test_gate_exposes_three_promoted_families_and_pending_six_family_set(self) -> None:
        ...
        self.assertEqual(summary["remaining_model_families_pending"], 6)
        self.assertEqual(summary["remaining_submodels_pending"], 120)
