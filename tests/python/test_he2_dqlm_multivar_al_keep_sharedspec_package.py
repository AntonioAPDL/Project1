...
class He2DqlmMultivarAlKeepSharedspecPackageTests(unittest.TestCase):
    def test_template_targets_al_keep_family(self) -> None:
        ...
        self.assertIn('dqlm_multivar_al_keep_all_cutoffs_sharedspec_20260517', payload['campaign']['artifact_root'])
        self.assertEqual(payload['validation']['cutoff_smoke_family'], 'dqlm_multivar_al_keep')
        self.assertEqual(payload['validation']['quantile_fit_smoke_family'], 'dqlm_multivar_al_keep')
        self.assertEqual(payload['validation']['full_pipeline_quantile_family'], 'dqlm_multivar_al_keep')
        ...
        self.assertEqual(
            ...
            [
                {'cutoff': '20210123', 'family': 'dqlm_multivar_al_keep', 'quantiles': [0.5]},
                {'cutoff': '20221225', 'family': 'dqlm_multivar_al_keep', 'quantiles': [0.65]},
            ],
        )
        self.assertEqual(
    ...
    def test_batch_reuses_sharedspec_and_pins_likelihood_mode_al(self) -> None:
        ...
        self.assertEqual(payload['selection']['families'], ['dqlm_multivar_al_keep'])
        ...
        self.assertEqual(family_patch['family'], 'dqlm_multivar_al_keep')
        self.assertEqual(family_patch['manuscript_label'], 'AL-M-T1')
