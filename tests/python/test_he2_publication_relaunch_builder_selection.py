...
class HE2PublicationRelaunchBuilderSelectionTests(unittest.TestCase):
    ...
    def test_exdqlm_fullhistory_promotion_batch_builds_guarded_20221225_config(self) -> None:
        ...
        self.assertEqual(frozen['df_s2'], '0.9999')
        self.assertEqual(frozen['df_discrep'], '0.9999')
        ...
        self.assertEqual(frozen['config_patch_applied'], 'True')
        self.assertIn('"df_t": 0.99999', frozen['config_patch_json'])
        self.assertIn('"df_covs": 0.9999999', frozen['config_patch_json'])
        self.assertIn('"epsilon": 365.0', frozen['config_patch_json'])
        ...
        self.assertEqual(cfg['models']['exdqlm_multivar']['state_evolution']['df_t'], 0.99999)
        self.assertEqual(cfg['models']['exdqlm_multivar']['state_evolution']['df_s1'], 0.9999)
        self.assertEqual(cfg['models']['exdqlm_multivar']['state_evolution']['df_s2'], 0.9999)
        self.assertEqual(cfg['models']['exdqlm_multivar']['state_evolution']['df_s67'], 0.9999)
        self.assertEqual(cfg['models']['exdqlm_multivar']['state_evolution']['df_discrep'], 0.9999)
        self.assertEqual(cfg['models']['exdqlm_multivar']['state_evolution']['df_trans'], 0.9999999)
    ...
    def test_exdqlm_allcutoffs_fullhistory_promotion_batch_builds_guarded_configs(self) -> None:
        ...
        for cutoff in cutoffs:
            ...
            self.assertEqual(fit['legacy']['post_save_objective_enabled'], False)
            self.assertEqual(fit['legacy']['post_save_jsd_enabled'], False)
            self.assertEqual(fit['legacy']['post_save_jsd_gridsize'], 100)
