...
def test_master_workflow_audit_tracker_current_state() -> None:
    ...
    assert summary['publication_parity_gate']['blocked_rows'] == 0
    assert summary['publication_parity_gate']['remaining_model_families_pending'] == 3
    ...
    promoted = [r for r in rows if r['label'] in {'exAL-M-T1', 'AL-M-T1', 'exAL-M-T0', 'AL-M-T0', 'AL-U-T1', 'exAL-U-T1'}]
