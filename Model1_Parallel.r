...
samp.gamma_50 = samp.gamma 
samp.sigma_50 = samp.sigma
samp.uts_50 = samp.uts
samp.sts_50 = samp.sts 
samp.theta_50 = samp.theta 
samp.post.pred_50 = samp.post.pred 
new.uts.out_50 = new.uts.out
new.sts.out_50 = new.sts.out 
new.gamsig.out_50 = new.gamsig.out 
new.theta.out_50 = new.theta.out
seq.gamma_50 = seq.gamma
seq.sigma_50 = seq.sigma

vars_to_save <- c("samp.gamma_50", "samp.sigma_50", 
                  "samp.uts_50", "samp.sts_50", 
                  "samp.theta_50", "samp.post.pred_50", 
                  "new.uts.out_50", "new.sts.out_50", 
                  "new.gamsig.out_50", "new.theta.out_50",
                  "seq.gamma_50", "seq.sigma_50")


save_variables(vars_to_save, "variables_50.RData", "/home/jaguir26/projects/notebooks")
